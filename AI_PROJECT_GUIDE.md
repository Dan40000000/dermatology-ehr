...
4. Ask practicing dermatology clinicians to follow the [synthetic pilot protocol](docs/golden-visit-pilot-protocol.md). Measure time to a clinician-accepted note, correction burden, missed follow-up items, and confusing steps. Prioritize changes from observed failures before adding more AI features.
