...
export const envSchema = z.object({
  ...
  SENDGRID_API_KEY: stringOptional,
  SENDGRID_SMTP_HOST: stringOptional,
  SENDGRID_SMTP_USERNAME: stringOptional,
  SENDGRID_SMTP_API_KEY: stringOptional,
  TWILIO_SENDGRID_API_KEY: stringOptional,
  SENDGRID_TIMEOUT_MS: numberDefault(15000),
  SMTP_CONNECTION_TIMEOUT_MS: numberDefault(10000),
  SMTP_GREETING_TIMEOUT_MS: numberDefault(10000),
  SMTP_SOCKET_TIMEOUT_MS: numberDefault(15000),
  ...
  BACKUP_RETENTION_DAYS: numberDefault(2555),
  BACKUP_BUCKET: stringOptional,
  BACKUP_ENCRYPTION_ENABLED: booleanDefault(false),
  BACKUP_ENCRYPTED: booleanDefault(false),
  BACKUP_KMS_KEY_ID: stringOptional,
  AWS_BACKUP_KMS_KEY_ID: stringOptional,
  BACKUP_RESTORE_VERIFIED_AT: stringOptional,
  BACKUP_RESTORE_EVIDENCE_URL: stringOptional,
  ...
  PHAXIO_BASE_URL: stringOptional,
  ...
  OPENAI_LIVE_INSIGHTS_MODEL: stringOptional,
  OPENAI_BAA_APPROVED_ENDPOINTS: stringOptional,
  OPENAI_BAA_APPROVED_MODELS: stringOptional,
  OPENAI_RAW_AUDIO_ALLOWED: booleanDefault(false),
  OPENAI_SPEND_GUARD_DISABLED: booleanDefault(false),
  OPENAI_MAX_REQUESTS_PER_HOUR: numberDefault(20),
  OPENAI_MAX_REQUESTS_PER_DAY: numberDefault(100),
  OPENAI_MAX_AUDIO_SECONDS_PER_HOUR: numberDefault(900),
  OPENAI_MAX_AUDIO_SECONDS_PER_DAY: numberDefault(3600),
  OPENAI_AMBIENT_LIVE_INSIGHTS_MIN_INTERVAL_MS: numberDefault(30000),
  OPENAI_AMBIENT_LIVE_TRANSCRIPTION_MIN_INTERVAL_MS: numberDefault(10000),
  HIPAA_AI_ENABLED: booleanDefault(false),
  ...
  ANTHROPIC_BAA_ENABLED: booleanDefault(false),
  AWS_HEALTHSCRIBE_BAA_ENABLED: booleanDefault(false),
  AWS_HEALTHSCRIBE_API_CALLS_ENABLED: booleanDefault(false),
  ABRIDGE_BAA_ENABLED: booleanDefault(false),
  NABLA_BAA_ENABLED: booleanDefault(false),
  WISPR_FLOW_BAA_ENABLED: booleanDefault(false),
  ...
  AMBIENT_LIVE_AI_ENABLED: booleanDefault(false),
  AMBIENT_LIVE_AI_MIN_INTERVAL_MS: numberDefault(15000),
  AMBIENT_LIVE_AI_MIN_CHARS: numberDefault(180),
  AMBIENT_LIVE_AI_MIN_DELTA_CHARS: numberDefault(80),
