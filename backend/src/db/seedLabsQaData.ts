...
async function seedLabsQaData() {
  ...
  const seedOrders: SeedOrder[] = [
    ...
    },
    {
      ...
      status: "pending",
      priority: "urgent",
      details: "TB QuantiFERON Gold + Hepatitis B panel",
      notes: "QA seed: biologic therapy baseline screening labs",
    ...
    },
    {
      ...
      status: "in-progress",
      priority: "high",
      details: "ANA panel + anti-dsDNA + C3/C4",
      notes: "QA seed: autoimmune workup in progress",
    ...
    },
    {
      ...
      status: "completed",
      priority: "normal",
      details: "Ferritin/Iron studies + Zinc level",
      notes: "QA seed: completed alopecia nutrition panel",
    ...
    },
    {
      ...
      status: "pending",
      priority: "stat",
      details: "Excisional biopsy - pigmented lesion left upper back",
      notes: "QA seed: urgent melanoma rule-out specimen pending",
    ...
    },
    {
      ...
      status: "in-progress",
      priority: "high",
      details: "Shave biopsy - right temple pearly papule (BCC r/o)",
      notes: "QA seed: dermatopathology review in progress",
    ...
    },
    {
      ...
      status: "completed",
      priority: "normal",
      details: "Punch biopsy - chronic eczematous plaque, left forearm",
      notes: "QA seed: completed pathology with finalized diagnosis workflow test",
