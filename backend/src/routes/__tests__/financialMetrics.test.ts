...
describe("Financial metrics routes", () => {
  it("GET /financial-metrics/dashboard returns metrics", async () => {
    getFinancialSnapshotsMock.mockResolvedValueOnce({
      daily: {
        ...
        standaloneRevenueCents: 50,
        totalRevenueCents: 550,
        collectionsCents: 1200,
        avgRevenuePerVisitCents: 167,
        benchmarkVisitsCount: 2,
        collectionRate: 25,
        revenueCategories: [{ key: "late_fee", label: "Late Fees", revenueCents: 50, itemCount: 1 }],
      },
      weekly: {
        key: "weekly",
        label: "Weekly Snapshot",
        ...
        standaloneRevenueCents: 50,
        totalRevenueCents: 2050,
        collectionsCents: 2200,
        avgRevenuePerVisitCents: 400,
        benchmarkVisitsCount: 4,
        collectionRate: 110,
        revenueCategories: [{ key: "office_visit", label: "Dr Appts", revenueCents: 1950, itemCount: 4 }],
      },
      monthly: {
        key: "monthly",
        label: "Monthly Snapshot",
        ...
        standaloneRevenueCents: 50,
        totalRevenueCents: 4050,
        collectionsCents: 5000,
        avgRevenuePerVisitCents: 500,
        benchmarkVisitsCount: 6,
        collectionRate: 125,
        revenueCategories: [{ key: "office_visit", label: "Dr Appts", revenueCents: 3950, itemCount: 8 }],
      },
      sourceNote: "note",
    });
    queryMock
  ...
  it("GET /financial-metrics/collections-trend returns trend and summary", async () => {
      ...
      rows: [
        {
          ...
          notes: "[LATE_FEE]|appointmentId=appt-1",
          appointment_type_name: null,
          cpt_codes: "LATEFEE",
          line_descriptions: "Late cancellation fee",
          encounter_id: null,
        },
        {
          day: "2026-02-02",
          ...
          cpt_codes: "99203",
          line_descriptions: "Office visit",
          encounter_id: "enc-1",
        },
      ],
    });
    ...
    expect(res.body.summary.revenueCategories).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ key: "late_fee", revenueCents: 5000 }),
