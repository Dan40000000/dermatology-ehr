  ...
  try {
    ...
    const result = await pool.query(
      `select
        ...
        p.delivery_method as "deliveryMethod", p.delivery_status as "deliveryStatus",
        p.delivery_notes as "deliveryNotes", p.documented_at as "documentedAt",
        p.last_printed_at as "lastPrintedAt", p.manually_filled_at as "manuallyFilledAt",
