...
import { CHARGE_CAPTURE_ROLES } from "../lib/roles";
...
export function registerRoutes(app: Express) {
  ...
  const requireClearinghouseAccess = [requireAuth, requireModuleAccess("clearinghouse")];
  const requireFinancialDashboardAccess = [requireAuth, requireModuleAccess("financials")];
  ...
  app.use("/api/fee-schedules", ...requireFinancialDashboardAccess, feeSchedulesRouter);
  app.use("/api/cpt-codes", cptCodesRouter);
  app.use("/api/icd10-codes", icd10CodesRouter);
  app.use("/api/claims", ...requireClaimsAccess, claimsRouter);
  ...
  app.use("/api/payer-payments", ...requireFinancialDashboardAccess, payerPaymentsRouter);
  app.use("/api/patient-payments", ...requireFinancialDashboardAccess, patientPaymentsRouter);
  ...
  app.use("/api/billing", ...requireFinancialDashboardAccess, billingRouter);
  ...
  app.use("/api/rcm", ...requireFinancialDashboardAccess, revenueCycleRouter);
  ...
  app.use("/api/claims-submission", ...requireClaimsAccess, claimsSubmissionRouter);
