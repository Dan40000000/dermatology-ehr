...
export const PATIENT_ALEX = {
  ...
  accessibilityProfile: {
    communicationSupport: ['electronic_forms'],
    extendedVisit: true,
    extraVisitMinutes: 10,
    notes: 'Prefers portal documents before visits so medication questions can be prepared.',
    lastReviewedAt: '2026-04-01T09:00:00Z',
    lastReviewedBy: 'Demo Front Desk',
  },
  insuranceDetails: {
    primary: {
...
export const PATIENT_JANE = {
  ...
  accessibilityProfile: {
    communicationSupport: ['large_print', 'electronic_forms'],
    accessibleRoomRequired: true,
    accessibleEquipment: ['height_adjustable_exam_table'],
    serviceAnimal: true,
    extendedVisit: true,
    extraVisitMinutes: 20,
    notes: 'Latex allergy and service animal access should be reviewed before rooming.',
    lastReviewedAt: '2026-05-01T10:15:00Z',
    lastReviewedBy: 'Demo MA',
  },
  insuranceDetails: {
    primary: {
      payer: 'Aetna',
...
export const PATIENT_MARCUS = {
  ...
  accessibilityProfile: {
    communicationSupport: ['captions'],
    sensoryConsiderations: 'Prefers low-noise room for telehealth medication counseling.',
    notes: 'Use captions for video visits when available.',
    lastReviewedAt: '2026-04-20T08:30:00Z',
    lastReviewedBy: 'Demo Scheduler',
  },
  insuranceDetails: {
    primary: {
...
export const DEMO_BIOPSIES = [
  {
    id: 'bio-demo-alex-benign',
    ...
    location_laterality: 'right',
    location_details: 'Dorsal mid forearm',
    clinical_description: 'Suspicious pigmented papule, rule out melanoma versus dermatofibroma.',
    clinical_history: 'Psoriasis patient on methotrexate with new changing lesion.',
    differential_diagnoses: ['Melanoma', 'Basal cell carcinoma', 'Dermatofibroma'],
    indication: 'Changing pigmented lesion',
    ordering_provider_id: 'demo-provider-1',
    ...
    path_lab_case_number: 'MP-26-03108',
    status: 'closed',
    ordered_at: '2026-03-08T10:45:00Z',
    collected_at: '2026-03-08T10:50:00Z',
    sent_at: '2026-03-08T16:30:00Z',
    received_by_lab_at: '2026-03-09T08:15:00Z',
    resulted_at: '2026-03-12T08:00:00Z',
    reviewed_at: '2026-03-12T09:10:00Z',
    closed_at: '2026-03-12T09:35:00Z',
    pathology_diagnosis: 'Benign intradermal nevus. No evidence of malignancy.',
    pathology_report: 'Punch biopsy right forearm: benign intradermal nevus. Margins not clinically relevant.',
    ...
    patient_notified_at: '2026-03-12T09:30:00Z',
    patient_notified_method: 'portal',
    turnaround_time_days: 4,
    procedure_code: '11104',
  },
  {
    id: 'bio-demo-jane-bcc-closed',
    tenant_id: 'tenant-demo',
    tenantId: 'tenant-demo',
    ...
    encounter_id: 'enc-j1',
    encounterId: 'enc-j1',
    specimen_id: 'BX-20251203-001',
    specimen_type: 'punch',
    specimen_size: '6 mm',
    body_location: 'Right cheek',
    location_laterality: 'right',
    location_details: 'Central malar cheek',
    clinical_description: 'Pearly papule with arborizing vessels on dermoscopy.',
    clinical_history: 'High clinical suspicion for basal cell carcinoma.',
    differential_diagnoses: ['Basal cell carcinoma', 'Trichoepithelioma'],
    indication: 'Neoplasm of uncertain behavior',
    ordering_provider_id: 'demo-provider-1',
    ordering_provider_name: 'Dr. David Skin, MD, FAAD',
    reviewing_provider_id: 'demo-provider-1',
    reviewing_provider_name: 'Dr. David Skin, MD, FAAD',
    path_lab: 'DermPath Diagnostics',
    path_lab_case_number: 'DP-25-12003',
    status: 'closed',
    ordered_at: '2025-12-03T15:00:00Z',
    collected_at: '2025-12-03T15:05:00Z',
    sent_at: '2025-12-03T17:00:00Z',
    received_by_lab_at: '2025-12-04T08:10:00Z',
    resulted_at: '2025-12-06T10:00:00Z',
    reviewed_at: '2025-12-06T10:25:00Z',
    closed_at: '2026-02-20T12:45:00Z',
    pathology_diagnosis: 'Nodular basal cell carcinoma, right cheek.',
    pathology_report: 'Nodular basal cell carcinoma extending to the deep edge of the specimen.',
    malignancy_type: 'BCC',
    malignancy_subtype: 'nodular',
    margins: 'involved',
    diagnosis_code: 'C44.319',
    diagnosis_description: 'Basal cell carcinoma of skin of other parts of face',
    follow_up_action: 'mohs',
    patient_notified: true,
    patient_notified_at: '2025-12-06T11:05:00Z',
    patient_notified_method: 'phone',
    reexcision_required: true,
    reexcision_scheduled_date: '2026-02-20',
    turnaround_time_days: 3,
    procedure_code: '11104',
  },
  {
    id: 'bio-demo-marcus-overdue',
    tenant_id: 'tenant-demo',
    tenantId: 'tenant-demo',
    ...
    location_laterality: 'left',
    location_details: 'Posterior shoulder line',
    clinical_description: 'Irregular brown macule with regression structures on dermoscopy.',
    clinical_history: 'New changing lesion noted during acne follow-up.',
    differential_diagnoses: ['Dysplastic nevus', 'Melanoma'],
    indication: 'Changing lesion',
    ordering_provider_id: 'demo-provider-3',
    ordering_provider_name: 'Dr. Maria Martinez, MD, FAAD',
    path_lab: 'Mountain Pine Pathology Lab',
    path_lab_case_number: 'MP-26-05003',
    status: 'sent',
    ordered_at: '2026-05-03T11:10:00Z',
    collected_at: '2026-05-03T11:18:00Z',
    sent_at: '2026-05-03T16:45:00Z',
    received_by_lab_at: '2026-05-04T08:05:00Z',
    resulted_at: null,
    reviewed_at: null,
  ...
  {
    id: 'bio-demo-sofia-melanoma-review',
    tenant_id: 'tenant-demo',
    tenantId: 'tenant-demo',
    ...
    specimen_size: '1.2 cm',
    body_location: 'Left posterior calf',
    location_laterality: 'left',
    location_details: 'Posterior calf, 11 cm below popliteal crease',
    clinical_description: 'Asymmetric dark macule with irregular network and blue-white veil.',
    clinical_history: 'Rapidly changing pigmented lesion.',
    differential_diagnoses: ['Melanoma', 'Atypical nevus'],
    indication: 'Rule out melanoma',
    ordering_provider_id: 'demo-provider-1',
    ordering_provider_name: 'Dr. David Skin, MD, FAAD',
    path_lab: 'DermPath Diagnostics',
    path_lab_case_number: 'DP-26-05113',
    status: 'resulted',
    ordered_at: '2026-05-13T14:05:00Z',
    collected_at: '2026-05-13T14:15:00Z',
    sent_at: '2026-05-13T17:10:00Z',
    received_by_lab_at: '2026-05-14T08:30:00Z',
    resulted_at: '2026-05-16T09:20:00Z',
    reviewed_at: null,
    pathology_diagnosis: 'Melanoma, superficial spreading type, Breslow depth 0.6 mm.',
    pathology_report: 'Superficial spreading melanoma. Breslow depth 0.6 mm. No ulceration. Margins close.',
    ...
    patient_notified: false,
    turnaround_time_days: 3,
    procedure_code: '11602',
  },
  {
    id: 'bio-demo-jane-scc-notify',
    tenant_id: 'tenant-demo',
    tenantId: 'tenant-demo',
    patient_id: 'demo-patient-2',
    patientId: 'demo-patient-2',
    ...
    location_laterality: 'left',
    location_details: 'Dorsal hand near second MCP',
    clinical_description: 'Tender hyperkeratotic papule.',
    clinical_history: 'History of non-melanoma skin cancer.',
    differential_diagnoses: ['Squamous cell carcinoma', 'Hypertrophic actinic keratosis'],
    indication: 'Rule out SCC',
    ordering_provider_id: 'demo-provider-2',
    ordering_provider_name: 'Riley Johnson, PA-C',
    reviewing_provider_id: 'demo-provider-1',
    reviewing_provider_name: 'Dr. David Skin, MD, FAAD',
    path_lab: 'Mountain Pine Pathology Lab',
    path_lab_case_number: 'MP-26-05114',
    status: 'reviewed',
    ordered_at: '2026-05-14T09:35:00Z',
    collected_at: '2026-05-14T09:44:00Z',
    sent_at: '2026-05-14T17:00:00Z',
    received_by_lab_at: '2026-05-15T08:15:00Z',
    resulted_at: '2026-05-16T07:45:00Z',
    reviewed_at: '2026-05-16T10:05:00Z',
    pathology_diagnosis: 'Squamous cell carcinoma in situ, transected at base.',
    pathology_report: 'SCC in situ with extension to deep margin.',
    malignancy_type: 'SCC',
  ...
  },
  {
    ...
    location_laterality: 'right',
    location_details: 'Right nasal ala',
    clinical_description: 'Pearly papule with focal crust.',
    clinical_history: 'New lesion, bleeds intermittently.',
    differential_diagnoses: ['Basal cell carcinoma', 'Fibrous papule'],
    indication: 'Rule out BCC',
    ordering_provider_id: 'demo-provider-1',
    ordering_provider_name: 'Dr. David Skin, MD, FAAD',
    reviewing_provider_id: 'demo-provider-1',
    reviewing_provider_name: 'Dr. David Skin, MD, FAAD',
    path_lab: 'DermPath Diagnostics',
    path_lab_case_number: 'DP-26-05110',
    status: 'reviewed',
    ordered_at: '2026-05-10T13:20:00Z',
    collected_at: '2026-05-10T13:30:00Z',
    sent_at: '2026-05-10T17:05:00Z',
    received_by_lab_at: '2026-05-11T08:20:00Z',
    resulted_at: '2026-05-13T08:40:00Z',
    reviewed_at: '2026-05-13T11:15:00Z',
    pathology_diagnosis: 'Basal cell carcinoma, nodular type, transected.',
    pathology_report: 'Nodular basal cell carcinoma extending to base.',
    malignancy_type: 'BCC',
    malignancy_subtype: 'nodular',
    margins: 'involved',
    ...
    patient_notified: true,
    patient_notified_at: '2026-05-13T12:10:00Z',
    patient_notified_method: 'phone',
    turnaround_time_days: 3,
    procedure_code: '11102',
  },
