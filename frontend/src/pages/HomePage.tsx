...
export function HomePage() {
      ...
      setCommandQueues({
        riskItems: [
          ...
          },
          {
            ...
            detail: 'Denied, rejected, appealed, or scrub-failed claims',
            route: '/claims?queue=exceptions',
            access: 'claims',
  ...
  const priorityItems = [
    ...
    },
    {
      ...
      detail: `${stats.claimsDeniedRejected} denied, rejected, appealed, or scrub-failed claims`,
      route: '/claims?queue=exceptions',
      access: 'claims',
